...
description: Browser automation, debugging, and performance analysis using Puppeteer CLI scripts. Use for automating browsers, taking screenshots, analyzing performance, monitoring network traffic, web scraping, form automation, JavaScript debugging, and debugging web apps (frontend bugs, UI issues, console errors, network traces). Connects to an existing Chrome remote-debugging port (default 9222).
license: Apache-2.0
...
cd tools/chrome-devtools/scripts
...
All scripts are in `tools/chrome-devtools/scripts/`
...
2. Verify in `tools/chrome-devtools/scripts/` directory
