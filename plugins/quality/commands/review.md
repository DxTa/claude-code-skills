...
#### Agent 1: Code Quality & AGENTS.md Compliance
```
Task(
  subagent_type="pr-review-toolkit:code-reviewer",
  prompt="Review git diff for code quality issues and AGENTS.md compliance. Focus on: bugs, style violations, missing tests, architectural issues. BASE_SHA: [sha] HEAD_SHA: [sha]"
)
```
...
- **code** - Code quality and AGENTS.md compliance
